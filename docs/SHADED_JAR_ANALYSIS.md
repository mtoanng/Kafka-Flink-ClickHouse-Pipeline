...
2.2.2. Kafka and the Scylla driver previously added duplicate Guava/HdrHistogram
...
overlaps from independently packaged connector bundles (Flink Avro, Scylla
