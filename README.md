...
# Kiến trúc hệ thống:
- `Apache Kafka`: Đóng vai trò broker chịu tải, tiếp nhận dữ liệu từ nhiều nguồn và phân phối tới hệ thống phân tích. 
- `Apache Flink`: Sử dụng cho mục đích xử lý, phân tích dữ liệu từ Kafka theo thời gian thực.
